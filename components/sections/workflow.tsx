...
export default function Workflow(){
  ...
  return <section className="section shell" id="workflow"><div className="workflow-layout"><div><SectionHeading number="04" label="METHOD" title="How I investigate an alert." description="Context. Evidence. A clear handoff."/><a className="text-link" href="#investigation">Try the investigation demo<ArrowRight size={16}/></a></div>
